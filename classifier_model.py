...
# Read CSV
train_df_main = pd.read_csv('./archive/train_df_main.csv', index_col=0)
...
print('Scans found:', len(all_image_paths), ', Total Headers', train_df_main.shape[0])
...
base_mobilenet_model = DenseNet121(input_shape = (*IMAGE_SIZE, 3), 
