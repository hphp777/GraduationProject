...
def delete_image(request, patient_pk, image_pk):
    models.Image.objects.filter(pk=image_pk).delete()
    return redirect(reverse("patients:detail", kwargs={"pk": patient_pk}))
