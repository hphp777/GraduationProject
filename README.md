...
-> Regarding academic integrity, the project's generated data and model parameters are officially submitted and shared with anyone who wants to access them via this GitHub and GoogleDrive, but unfortunately, the GoogleDrive links have expired, and the data are deprecated at some points for unknown reasons. There were no competing interests among all judges, reviewers of the papers from this project, and all other students.
...
###### Code for training classification model training is heavily based on: [Kaggle](https://www.kaggle.com/code/redwankarimsony/nih-chest-x-ray8-classifier-cnn-visualization)
...
###### Generated Image(Subset1): [Google Drive Link](https://drive.google.com/drive/folders/1qJj4dn9ap-fPbrHuP2OR9f7_tTKUm58L?usp=sharing)
###### Generated Image(Subset2): [Google Drive Link](https://drive.google.com/drive/folders/1IWavLvJQTNJ_Ui-s0R7is2MTI1Q3naOe?usp=sharing)
###### Generated Image(Subset3): [Google Drive Link](https://drive.google.com/drive/folders/1q1PmqqxZPPGEzazGkzOXv4WF1G5zFNO1?usp=sharing)
