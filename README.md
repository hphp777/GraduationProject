...
-> Regarding academic integrity, the project's generated data and model parameters are officially submitted and shared with anyone via this GitHub and GoogleDrive, but unfortunately, the GoogleDrive links have expired, and the data are deprecated at some points for unknown reasons. There were no competing interests among all judges, reviewers of the papers from this project, and all other students.
